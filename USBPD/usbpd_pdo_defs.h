...
#define PORT0_NB_SINKPDO           2U   /* Number of Sink PDOs (applicable for port 0)     */
...
uint32_t PORT0_PDO_ListSNK[USBPD_MAX_NB_PDO] =
{
  ...
  (
    ...
    USBPD_PDO_SNK_VARIABLE_SET_OP_CURRENT(1000U)         | /* Max Current mA           */
    USBPD_PDO_SNK_VARIABLE_SET_MAX_VOLTAGE(12000U)     | /* Max Voltage mV           */
    USBPD_PDO_SNK_VARIABLE_SET_MIN_VOLTAGE(9000U)            /* Min Voltage mV           */
  ),
