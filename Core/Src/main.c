...
void TestTelemetry(char *telemetry_string){
	...
	// 2 bytes - telemetry_string[96:97]
	int16_t test_gyro_rate = ((int16_t)telemetry_string[96] << 4) | (int16_t)telemetry_string[97];

	// Comma-Space - telemetry_string[98:99]

	//   3 bytes - 1 for hour, minute, and second each,
	// + 2 bytes for colon in between (SKIP).
	// 5 bytes - telemetry_string[100:104]
	uint32_t test_gps_time = ((uint32_t)telemetry_string[100] * 60 * 60) + ((uint32_t)telemetry_string[102] * 60) + ((uint32_t)telemetry_string[104]);

	// Comma-Space - telemetry_string[105:106]

	// 4 bytes - telemetry_string[107:110]
	float test_gps_altitude;
	float gps_alt[4] = {telemetry_string[107], telemetry_string[108], telemetry_string[109], telemetry_string[110]};
	memcpy(&test_gps_altitude, &gps_alt, sizeof(test_gps_altitude));

	// Comma-Space - telemetry_string[111:112]

	// 4 bytes - telemetry_string[113:116]
	float test_gps_latitude;
	float gps_lat[4] = {telemetry_string[113], telemetry_string[114], telemetry_string[115], telemetry_string[116]};
	memcpy(&test_gps_latitude, &gps_lat, sizeof(test_gps_latitude));

	// Comma-Space - telemetry_string[117:118]

	// 4 bytes - telemetry_string[119:122]
	float test_gps_longitude;
	float gps_long[4] = {telemetry_string[119], telemetry_string[120], telemetry_string[121], telemetry_string[122]};
	memcpy(&test_gps_longitude, &gps_long, sizeof(test_gps_longitude));

	// Comma-Space - telemetry_string[123:124]

	// 1 byte - telemetry_string[125]
	uint8_t test_gps_sats = (uint8_t) telemetry_string[125];

	// Comma-Space - telemetry_string[126:127]

	// 10 bytes - telemetry [128:137]
	char test_cmd[] = {telemetry_string[128], telemetry_string[129], telemetry_string[130], telemetry_string[131], telemetry_string[132],
						telemetry_string[133], telemetry_string[134], telemetry_string[135], telemetry_string[136], telemetry_string[137]};
